...
(function () {
        ...
        if (!design.asset?.url) {
            return `
                <div class="customer-design-status">
                    ...
                    pendiente de envío por Emmagina.
                </div>
            `;
        }
        ...
        return `
            <section class="customer-design-review" data-line-id="${escapeHtml(item.lineaId)}">
                ...
                <a href="${escapeHtml(design.asset.url)}" target="_blank" rel="noopener">
                    <img src="${escapeHtml(design.asset.url)}" alt="Diseño final enviado por Emmagina">
                </a>
    ...
    function transferBlock(order) {
        ...
        const whatsappUrl = `${CONFIG.social?.whatsapp || "https://wa.me/56900000000"}?text=${whatsappMessage}`;
                ...
                <div class="transfer-security-notice">
                    ...
                    <p>
                        ${escapeHtml(
                            ...
                            "Los datos bancarios se entregarán únicamente mediante un canal oficial de Emmagina."
                        )}
                    </p>
                    <p>
    ...
    function cancelOrderBlock(order) {
        ...
        return `
            <section class="account-detail-card customer-cancel-order-card">
                ...
                <p class="account-help-text">
                    Si ya pagaste o necesitas un cambio/reembolso, contáctanos a contacto@emmagina.cl o por WhatsApp.
                </p>
            </section>
        `;
    }
        ...
        container.querySelector(".receipt-upload-form")?.addEventListener(
            ...
            async (event) => {
                ...
                try {
                    ...
                    alert("Comprobante recibido. Emmagina revisará la transferencia.");
                    await initOrder();
                } catch (error) {
